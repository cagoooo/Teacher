...
import { Plus, Calendar, Clock, User, ChevronRight, X, Check, Trash2, Edit2 } from 'lucide-react';

const OfficialSubstitute = () => {
    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                <div>
                    <h1 style={{ margin: 0, fontSize: '2rem', color: 'var(--color-text)', fontWeight: '800' }}>公假代課管理</h1>
                    <p style={{ margin: '8px 0 0 0', color: 'var(--color-text-light)' }}>管理公假請假單與代課指派</p>
                </div>
            ...
            {loading ? (
                ...
                <Card style={{ textAlign: 'center', padding: '60px' }}>
                    <p style={{ color: '#888', marginBottom: '16px' }}>目前沒有公假請假單</p>
...
// 新增請假單 Modal
const AddLeaveModal = ({ teachers, onClose, onSuccess }) => {
        ...
        <div style={{
            ...
            <Card style={{ width: '90%', maxWidth: '500px', maxHeight: '90vh', overflow: 'auto' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <h2 style={{ margin: 0, color: 'var(--color-text)' }}>新增公假請假單</h2>
            ...
            <Card style={{ width: '90%', maxWidth: '600px', maxHeight: '90vh', overflow: 'auto' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                        ...
                        <span style={{ color: '#888' }}>({record.leaveType})</span>
                    </div>
...
export default OfficialSubstitute;
